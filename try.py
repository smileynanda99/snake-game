...
# Game Title
pygame.display.set_caption("SnakesBy_RK.NANDA")
...
def welcome():
    ...
    while not exit_game:
        bgimg3 = pygame.image.load("welcome.jpg")
        bgimg3 = pygame.transform.scale(bgimg3, (screen_width, screen_height)).convert_alpha()
        gameWindow.fill(white)
        gameWindow.blit(bgimg3, (0, 0))
        text_screen("Welcome to Snakes", black, screen_width/3, 300)
        text_screen("Press Space Bar To Play", black, screen_width/3-40, 350)
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_SPACE:
                    pygame.mixer.music.load('djsnake.mp3')
                    pygame.mixer.music.play()
                    gameloop()
...
def gameloop():
    ...
    while not exit_game:
        if game_over:
            ...
            text_screen("Game Over! Press Enter To Continue", red,screen_width/7, 300)
            text_screen("Your Score: " + str(score), red, screen_width/3+20, 250)
            ...
            text_screen("Score: " + str(score) + "  Hiscore: "+str(hiscore), any, 5, 5)
